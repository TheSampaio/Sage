...
namespace Sage.Core
{
    ...
    /// Handles ABI compliance, formatting, and tree-shaking for headers.
    /// </summary>
    public class CodeGenerator : ICodeGenerator, IAstVisitor<string>
    {
        ...
        // Usage Flags for Tree Shaking
        private bool _usesStdIo = false;   // For <stdio.h>
        private bool _usesTypes = false;   // For typedefs, <stdint.h>, <stdbool.h>
        ...
        public string Generate(ProgramNode ast)
        {
            ...
            // 2. Generate the Body FIRST to populate flags (Tree Shaking)
            // We buffer the body code so we can decide on headers later.
            ...
            // Optional Includes based on usage
            if (_usesStdIo)
            {
        ...
        public string Visit(FunctionDeclarationNode node)
        {
            ...
            // "main" is special: it returns 'int' natively in C, so it doesn't strictly need typedefs
            // unless the user explicitly requested a Sage type return.
